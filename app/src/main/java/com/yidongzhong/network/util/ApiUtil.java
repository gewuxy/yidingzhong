package com.yidongzhong.network.util;

import android.content.Context;
import android.text.TextUtils;

import com.yidingzhong.uikit.common.util.system.NetworkUtil;
import com.yidongzhong.BuildConfig;
...
public class ApiUtil {
    public static String getExtraHeaderInfo(Context mContext) {
        ...
        // 添加版本号
        extraHeaderInfo += " Lycheer/" + BuildConfig.VERSION_NAME;
