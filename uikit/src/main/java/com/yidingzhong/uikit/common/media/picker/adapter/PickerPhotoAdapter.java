...
import com.yidingzhong.uikit.common.media.picker.loader.RotateImageViewAware;
import com.yidingzhong.uikit.common.media.picker.model.PhotoInfo;
import com.yidingzhong.uikit.common.media.picker.util.ThumbnailsUtil;
...
public class PickerPhotoAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewGroup.LayoutParams hotpotLayoutParams = viewHolder.selectHotPot.getLayoutParams();
        ...
        viewHolder.selectHotPot.setOnClickListener(new View.OnClickListener() {
