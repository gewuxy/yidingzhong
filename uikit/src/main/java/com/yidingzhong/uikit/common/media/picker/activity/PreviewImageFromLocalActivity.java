...
import com.yidingzhong.uikit.common.media.picker.adapter.ImagePagerAdapterInImageSwitch;
...
import com.yidingzhong.uikit.common.widget.dialog.EasyAlertDialog;
...
public class PreviewImageFromLocalActivity extends BaseActivity {
    ...
    private void sendOrigImage() {
        final BaseActivity activity = PreviewImageFromLocalActivity.this;
        ...
        allAlertDialog.addNegativeButton(getString(R.string.cancel), EasyAlertDialog.NO_TEXT_COLOR,
                EasyAlertDialog.NO_TEXT_SIZE, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
