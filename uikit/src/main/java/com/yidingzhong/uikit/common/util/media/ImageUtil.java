package com.yidingzhong.uikit.common.util.media;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(UIKit.getContext().getResources(), R.drawable.default_img_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static int[] getBoundWithLength(int maxSide, Object imageObject, boolean resizeToDefault) {
        ...
        if (String.class.isInstance(imageObject)) {
            ...
            bound = BitmapDecoder.decodeBound(UIKit.getContext().getResources(), (Integer) imageObject);
            width = bound[0];
            height = bound[1];
    ...
    public static Bitmap getBitmapFromDrawableRes(int res) {
        try {
            return getBitmapImmutableCopy(UIKit.getContext().getResources(), res);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
