package com.yidingzhong.uikit.common.widget.viewpager;
...
import com.yidingzhong.uikit.common.widget.drop.DropFake;
import com.yidingzhong.uikit.common.widget.drop.DropManager;
import com.yidingzhong.uikit.common.widget.drop.reminder.ReminderItem;
import com.yidingzhong.uikit.common.widget.drop.reminder.ReminderSettings;
...
public class PagerSlidingTabStrip extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private int indicatorColor = getResources().getColor(R.color.tab_selected);

    private int underlineColor = getResources().getColor(R.color.gray_666);

    private int dividerColor = 0x00000000;

    private int checkedTextColor = R.color.tab_selected;

    private int unCheckedTextColor = R.color.tab_normal;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        checkedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor, R.color.tab_selected);
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(R.layout.tab_layout, null);
        }
