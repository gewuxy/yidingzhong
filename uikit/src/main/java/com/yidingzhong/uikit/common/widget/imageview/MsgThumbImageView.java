package com.yidingzhong.uikit.common.widget.imageview;
...
import com.yidingzhong.uikit.framework.SingleThreadExecutor;
...
public class MsgThumbImageView extends ImageView {
    ...
    private static final DisplayImageOptions createImageOptions() {
        int defaultIcon = R.drawable.image_default;
    ...
    private void loadBmpAsync(final String imageUri, final String path, final ImageSize imageSize, final String tag) {
        SingleThreadExecutor.getInstance().execute(new SingleThreadExecutor.NimTask<Bitmap>() {
            @Override
