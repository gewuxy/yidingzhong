...
import com.yidingzhong.uikit.common.widget.datetimepicker.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.gray_999999);
        textColorCenter = getResources().getColor(R.color.gray_333333);
        dividerColor = getResources().getColor(R.color.gray_dddddd);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.text_size_20);
