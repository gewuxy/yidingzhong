...
import com.yidingzhong.uikit.common.media.player.AudioPlayer;
import com.yidingzhong.uikit.common.media.player.OnPlayListener;
...
public abstract class BaseAudioControl<T> {
    ...
    public void startPlayAudio(T t, AudioControlListener audioControlListener, int audioStreamType) {
